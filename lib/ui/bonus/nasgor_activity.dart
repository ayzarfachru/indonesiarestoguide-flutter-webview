...
class NasgorActivity extends StatefulWidget {
  @override
  _NasgorActivityState createState() => _NasgorActivityState();
}

class _NasgorActivityState extends State<NasgorActivity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
