...
class FoodTruckActivity extends StatefulWidget {
  @override
  _FoodTruckActivityState createState() => _FoodTruckActivityState();
}

class _FoodTruckActivityState extends State<FoodTruckActivity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
  ...
  Future _search3(String q, String type)async{
    ...
    // print(apiResult.body);
    var data = json.decode(apiResult.body);
    print('PIII '+data['resto'].toString());
