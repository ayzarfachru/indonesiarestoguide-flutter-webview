...
class TokoOleh2Activity extends StatefulWidget {
  @override
  _TokoOleh2ActivityState createState() => _TokoOleh2ActivityState();
}

class _TokoOleh2ActivityState extends State<TokoOleh2Activity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
                        ...
                        onTap: (){
                          Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: new DetailResto(tokooleh[index].id.toString())));
                        },
                        child: Container(
