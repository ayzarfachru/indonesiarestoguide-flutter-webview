...
class KakiLimaListActivity extends StatefulWidget {
  @override
  _KakiLimaListActivityState createState() => _KakiLimaListActivityState();
}

class _KakiLimaListActivityState extends State<KakiLimaListActivity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
                        ...
                        onTap: (){
                          Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: new DetailResto(kakilima[index].id.toString())));
                        },
                        child: Container(
