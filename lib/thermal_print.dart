...
class _ThermalPrintState extends State<ThermalPrint> {
  ...
  Future<List<int>> testTicket() async {
    ...
    bytes += generator.text('ORO - ORO DOWO',
        styles: PosStyles(
          bold: true,
          fontType: PosFontType.fontA,
          align: PosAlign.center,
    ...
    bytes += generator.text('________________________________',
        styles: PosStyles(bold: true, align: PosAlign.center), linesAfter: 1);
    ...
    // bytes += generator.text('________________________________', styles: PosStyles(bold: true, align: PosAlign.center), linesAfter: 1);
    // bytes += generator.text('Bold text', styles: PosStyles(bold: true, fontType: PosFontType.fontA,));
