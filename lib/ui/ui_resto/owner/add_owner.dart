...
class AddOwnerActivity extends StatefulWidget {
  String id;

  AddOwnerActivity(this.id);

  @override
  _AddOwnerActivityState createState() => _AddOwnerActivityState(id);
}

class _AddOwnerActivityState extends State<AddOwnerActivity> {
  String id;

  _AddOwnerActivityState(this.id);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ),
                      // SizedBox(height: CustomSize.sizeHeight(context) / 48,),
                      CustomText.bodyLight12(text: "Email", minSize: double.parse(((MediaQuery.of(context).size.width*0.03).toString().contains('.')==true)?((MediaQuery.of(context).size.width*0.03)).toString().split('.')[0]:((MediaQuery.of(context).size.width*0.03)).toString())),
                      SizedBox(
