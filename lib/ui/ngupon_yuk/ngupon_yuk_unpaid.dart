...
class NguponYukUnpaid extends StatefulWidget {
  @override
  _NguponYukUnpaidState createState() => _NguponYukUnpaidState();
}

class _NguponYukUnpaidState extends State<NguponYukUnpaid> {
                                          ...
                                          children: [
                                            ...
                                            CustomText.bodyMedium16c(
                                              ...
                                              text: NumberFormat.currency(
                                                  ...
                                                  symbol: 'Rp. ',
                                                  decimalDigits: 0)
                                                  .format((int.parse(nguponYuk[index].price.toString())+1000)),
                                              sizeNew: double.parse(
                                                  ((MediaQuery.of(context).size.width *
                                                      0.03)
                                                      .toString()
