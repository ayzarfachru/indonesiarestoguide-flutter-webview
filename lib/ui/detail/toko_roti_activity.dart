...
class TokoRotiActivity extends StatefulWidget {
  @override
  _TokoRotiActivityState createState() => _TokoRotiActivityState();
}

class _TokoRotiActivityState extends State<TokoRotiActivity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
                        ...
                        onTap: (){
                          Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: new DetailResto(tokoroti[index].id.toString())));
                        },
                        child: Container(
