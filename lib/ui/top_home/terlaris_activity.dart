                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              (homepg != "1")?(promo[index].price!.discounted == null)?CustomText.bodyRegular12(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(promo[index].price!.original), minSize: 12):CustomText.bodyRegular12(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(promo[index].price!.original), minSize: 12,
                                                ...
                                                children: [
                                                  (promoResto[index].menu != null)?Row(
                                                    children: [
                                                      CustomText.bodyRegular12(text: 'Harga :', minSize: 12),
                                                  ...
                                                  (promoResto[index].ongkir != null)?Row(
                                                    children: [
                                                      CustomText.bodyRegular12(text: 'Potongan Ongkir :', minSize: 12),
                                                      SizedBox(width: CustomSize.sizeWidth(context) / 48,),
                                                      CustomText.bodyRegular12(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(int.parse(promoResto[index].ongkir.toString())), minSize: 12,),
                                                    ],
                                                  ):Container(),
                                                  // (promoResto[index].menu != null)?Row(
                                                  //   children: [
                                              ...
                                              SizedBox(width: CustomSize.sizeWidth(context) / 48,),
                                              (promo[index].price!.discounted == null)?Container():CustomText.bodyRegular12(text: NumberFormat.currency(locale: 'id', symbol: '', decimalDigits: 0).format(promo[index].price!.discounted), minSize: 12),
                                            ],
                                          )
                                        ],
                                      ),
