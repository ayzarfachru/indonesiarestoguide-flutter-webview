...
class FoodStallActivity extends StatefulWidget {
  @override
  _FoodStallActivityState createState() => _FoodStallActivityState();
}

class _FoodStallActivityState extends State<FoodStallActivity> {
  void setState(fn) {
    if(mounted) {
      super.setState(fn);
    }
                        ...
                        onTap: (){
                          Navigator.push(
                              ...
                              PageTransition(
                                  ...
                                  child: new DetailResto(foodstall[index].id.toString())));
                        },
                        child: Container(
